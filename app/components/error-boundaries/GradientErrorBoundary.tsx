...
export class GradientErrorBoundary extends React.Component<Props, State> {
  ...
  render() {
    if (this.state.hasError) {
      return (
        <div className="p-6 rounded-xl bg-gradient-to-br from-purple-100 via-pink-50 to-red-100 border border-white/20 backdrop-blur-sm">
          <div className="text-center">
            ...
            <p className="text-gray-700 mb-6">We encountered an unexpected error. Please try refreshing the page.</p>
